...
class ShipSpecialWeapon(
    ...
    _mapper_utils = {
        "files": {
            "server": [
                "s_ShipCWeaponItem.bin"
            ],
            "client": [
                "c_ShipCWeaponItemRes.bin"
            ],
            "string": [
                "ShipCWeaponItemStr.dat"
            ],
        },
    }
    ...
    en_usage = CustomColumn(db.Integer, nullable=False, mapper_key="EN소모")
